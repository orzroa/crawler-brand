 ...
 */
@Slf4j
public class MogoCrawlerThread4Sh implements Runnable,LogService {

    private static final String HEAD_URL = "http://";
    private static final String MID_URL = "www";
    private static final String START_TAIL_URL = ".mgzf.com/list/";
    //  http://www.mgzf.com/list/
    ...
    public void run() {
        ...
        String startUrl = HEAD_URL + "www" +  START_TAIL_URL;
