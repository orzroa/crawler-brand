 ...
 */
@Slf4j
public class MogoCrawlerThread4Su implements Runnable,LogService {
    ...
    private static final String DETAIL_URL = "http://tj.mogoroom.com/room/";
    private static final String TAIL_URL = ".shtml";
